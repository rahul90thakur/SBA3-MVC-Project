...
<section class="container-fluid p-4">
			<h3>User Sign In info</h3>
	
			
			<c:choose>
				<c:when test="${contact==null || contact.isEmpty() }">
						...
						<tbody>
							<c:forEach var="c" items="${contact }">
								<tr>
									...
									<td>${c.contactDetails.addressLine1} ${c.contactDetails.addressLine2 }
									${c.contactDetails.city }  ${c.contactDetails.state }</td>
									<td>
